...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e asn1gih30o3yg-ats.iot.eu-north-1.amazonaws.com -r root-CA.crt -c DhT11_AWS.cert.pem -k DhT11_AWS.private.key
